#MenuTitle: Squares compensation 2
# -*- coding: utf-8 -*-
...
def get_delta(thisLayer):
	if thisLayer.master.customParameters['ItalDelta2']:
		a,b,c,d,e,f,g,h = [int(x) for x in re.findall('\-{0,1}\d+',
		thisLayer.master.customParameters['ItalDelta2'])]
	elif thisLayer.master.font.customParameters['ItalDelta2']:
		a,b,c,d,e,f,g,h = [int(x) for x in re.findall('\-{0,1}\d+',
		thisLayer.master.font.customParameters['ItalDelta2'])]
	else:
